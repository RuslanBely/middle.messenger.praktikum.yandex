    ...
    linkChange:{
      ...
      events:{
        'click':(event:Event) => {
          ...
          this.children.formProfile.children.submButton.element.style.display='block'
          for (const [, value] of Object.entries(this.children.formProfile.children)){
    ...
    linkChangePass:{
      ...
      events:{
        'click':(event:Event) => {
          ...
          const elemTar = event.target as HTMLElement 
          elemTar.parentElement!.parentElement!.style.display='none';              
          this.children.formProfilePass.children.submButtonPass.element.style.display='block'
          this.children.formProfilePass.element.style.display='block'
          for (const [, value] of Object.entries(this.children.formProfilePass.children)){
            const input= value.element as HTMLInputElement
            input.readOnly =false;}
        }
      }
